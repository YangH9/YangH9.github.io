...
;(function (window, document, undefined) {
  ...
  function gameloop() {
    for (var i = 0; i < texts.length; i++) {
      ...
      texts[
        i
      ].el.style.cssText = `left:${texts[i].x}px;top:${texts[i].y}px;opacity:${texts[i].alpha};transform:translateX(-50%) scale(${texts[i].scale},${texts[i].scale});color:${texts[i].color}`
    }
