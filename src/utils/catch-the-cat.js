...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    var k = (function (t) {
      function e(e, n, o) {
        var r = t.call(this, { key: 'MainScene' }) || this
      ...
      return (
        ...
        Object.defineProperty(e.prototype, 'blocksData', {
          get: function () {
            var t = []
            return (
              this.blocks.forEach(function (e, n) {
                ;(t[n] = []),
        ...
        (e.getNeighbours = function (t, e) {
          var n,
            ...
            a = { i: t + 1, j: e }
          0 == (1 & e)
            ? ((n = { i: t - 1, j: e - 1 }), (o = { i: t, j: e - 1 }), (r = { i: t - 1, j: e + 1 }), (i = { i: t, j: e + 1 }))
            : ((n = { i: t, j: e - 1 }), (o = { i: t + 1, j: e - 1 }), (r = { i: t, j: e + 1 }), (i = { i: t + 1, j: e + 1 }))
          var l = []
          return (l[0] = s), (l[1] = n), (l[2] = o), (l[3] = a), (l[4] = i), (l[5] = r), l
        }),
        (e.prototype.preload = function () {
          var t = this.r / s.default.catStepLength
          for (var e in s.default.textures) this.load.addFile(new c.default(this.load, e, s.default.textures[e], { scale: t }))
        }),
        ...
        (e.prototype.getPosition = function (t, e) {
          return { x: 3 * this.r + (0 == (1 & e) ? this.r : this.dx) + t * this.dx, y: 3 * this.r + this.r + e * this.dy }
        }),
        ...
        (e.prototype.playerClick = function (t, e) {
          if ((this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING))
            return this.setStatusText(f.default('游戏已经结束，重新开局')), this.reset(), !1
          var n = this.getBlock(t, e)
          return n
            ? n.isWall
              ? (this.setStatusText(f.default('点击位置已经是墙了，禁止点击')), !1)
              : this.cat.i === t && this.cat.j === e
              ? (this.setStatusText(f.default('点击位置是猫当前位置，禁止点击')), !1)
              : ((n.isWall = !0),
                this.cat.isCaught()
                  ? (this.setStatusText(f.default('猫已经无路可走，你赢了')), (this.state = i.WIN), !1)
                  : (this.setStatusText(f.default('您点击了 ') + '(' + t + ', ' + e + ')'),
                    this.cat.step() || (this.setStatusText(f.default('猫认输，你赢了！')), (this.state = i.WIN)),
                    !0))
            : (this.setStatusText(f.default('代码错误，当前位置不存在')), !1)
        }),
        ...
        (e.prototype.createAnimations = function () {
          ...
          s.default.animations.forEach(function (e) {
            ...
            e.textures.forEach(function (t) {
              n.push({ key: t, frame: 0 })
            }),
              t.anims.create({ key: e.name, frames: n, frameRate: s.default.frameRate, repeat: e.repeat })
          })
        }),
        (e.prototype.createBlocks = function () {
          for (var t = [], e = 0; e < this.w; e++) {
            ...
            for (var n = 0; n < this.h; n++) {
              var o = new l.default(this, e, n, 0.9 * this.r)
  ...
  function (t, e, n) {
    ...
    e.default = {
      ...
      animations: [
        { name: 'left_step', textures: ['left_1', 'left_2', 'left_3', 'left_4', 'left_5'], repeat: 0 },
        { name: 'top_left_step', textures: ['top_left_1', 'top_left_2', 'top_left_3', 'top_left_4', 'top_left_5'], repeat: 0 },
        { name: 'bottom_left_step', textures: ['bottom_left_1', 'bottom_left_2', 'bottom_left_3', 'bottom_left_4', 'bottom_left_5'], repeat: 0 },
        { name: 'left_run', textures: ['left_2', 'left_3', 'left_4', 'left_5'], repeat: 3 },
        { name: 'top_left_run', textures: ['top_left_2', 'top_left_3', 'top_left_4', 'top_left_5'], repeat: 3 },
        { name: 'bottom_left_run', textures: ['bottom_left_2', 'bottom_left_3', 'bottom_left_4', 'bottom_left_5'], repeat: 3 }
      ],
      origins: { left: { x: 0.75, y: 0.75 }, top_left: { x: 0.63, y: 0.83 }, bottom_left: { x: 0.65, y: 0.5 } },
      stopTextures: { left: 'left_1', top_left: 'top_left_1', bottom_left: 'bottom_left_1' },
      cannotEscapeTextures: { left: 'left_2', top_left: 'top_left_2', bottom_left: 'bottom_left_2' },
      directions: [
        { scaleX: 1, name: 'left' },
      ...
      s = (function (t) {
        function e(e) {
          ...
          var o = e.w,
            ...
            u = { width: l, height: d, type: Phaser.AUTO, parent: e.parent, backgroundColor: e.backgroundColor, scene: h, zoom: a }
    ...
    var i = n(0),
      ...
      l = (function (t) {
        ...
        return (
          ...
          (e.prototype.reset = function () {
            this.anims.stop(), (this.direction = s.default.catDefaultDirection), this.resetIJ()
          }),
          ...
          (e.prototype.escape = function () {
            0 === this.j || this.j === this.scene.h - 1
              ? this.runForward()
              : 0 === this.i
              ? this.runDirection(0)
              : this.i === this.scene.w - 1 && this.runDirection(3)
          }),
          ...
          (e.prototype.stepForward = function () {
            ...
            return (
              null !== n &&
              !n.isWall &&
              (this.play(s.default.directions[this.direction].name + '_step'),
  ...
  function (t, e, n) {
    ...
    e.default = function (t, e, n) {
      var r = -1
      return (
        o.default.getNeighbours(e, n).forEach(function (e, n) {
  ...
  function (t, e, n) {
    ...
    var i = (function (t) {
      function e(e, n, o, r) {
        ...
        return (
          i.setInteractive(a, Phaser.Geom.Circle.Contains),
  ...
  function (t, e, n) {
    ...
    var i = n(2),
      s = (function (t) {
        function e(e) {
          var n = t.call(this, e, 0, 0, i.default('重置'), {}) || this
          n.setColor('#000000')
          var o = e.r
  ...
  function (t, e, n) {
    ...
    var i = (function (t) {
      function e(e) {
        ...
        return (
          n.setFontSize(o),
          'center' === e.game.myConfig.statusBarAlign && (n.setX(e.game.canvas.width / 2), n.setOrigin(0.5, 0)),
  ...
  function (t, e, n) {
    ...
    var i = (function (t) {
      function e(e) {
        ...
        var o = e.r
        return n.setFontSize(0.8 * o), n.setPadding(o, o, o, o), n.setText(e.game.myConfig.credit), n
      }
      return r(e, t), e
    })(Phaser.GameObjects.Text)
    e.default = i
  ...
  function (t, e, n) {
    ...
    var o = n(0),
      r = (function () {
        ...
        return (
          Object.defineProperty(t.prototype, 'routesCount', {
            get: function () {
              var t = this
              if (void 0 === this._routesCount)
                if (this.isEdge) this._routesCount = 1
                else {
                  var e = 0
          ...
          Object.defineProperty(t.prototype, 'directions', {
            get: function () {
              var t = this,
                e = []
              return (
                this.neighbours.forEach(function (n, o) {
              ...
              var e = function () {
                ...
                e.neighbours.forEach(function (n) {
                  null === n ||
                    n.isEdge ||
                    n.isWall ||
                    (n.distance > e.distance + 1 && ((n.distance = e.distance + 1), t.indexOf(n) < 0 && t.push(n)))
                })
              };
              t.length > 0;
  ...
  function (t, e, n) {
    ...
    e.default = function (t, e) {
      var n = new o.default()
      return (
        n.open('GET', t.src, e.async, e.user, e.password),
        ...
        n.send(),
        setTimeout(function () {
          n.respond(200, { 'Content-Type': 'application/octet-stream' }, t.rawData)
        }, 1),
        n
      )
    }
    ...
    var d = {
      ...
      abort: function () {
        ;(this.aborted = !0),
          ...
          this.readyState > l.UNSENT && this.sendFlag && (this._readyStateChange(l.UNSENT), (this.sendFlag = !1)),
      ...
      _setResponseBody: function (t) {
        ...
        var o,
          r,
          i = this.getResponseHeader('Content-Type')
        if (this.responseText && (!i || /(text\/xml)|(application\/xml)|(\+xml)/.test(i)))
          try {
            this.responseXML =
              ((o = this.responseText),
              'undefined' != typeof DOMParser
                ? (r = new DOMParser().parseFromString(o, 'text/xml'))
                : (((r = new ActiveXObject('Microsoft.XMLDOM')).async = 'false'), r.loadXML(o)),
              r)
          } catch (t) {}
