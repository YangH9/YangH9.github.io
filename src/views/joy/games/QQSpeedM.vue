<template>
  <div class="container">
    ...
    <a-card
      ...
      <template #title>
        ...
        <a-row justify="space-around">
          <a-col
            ...
            :key="index">
            <a-button
              :type="typeListActive === item.key ? 'primary' : ''"
              @click="typeListActive = item.key">
              {{ item.title }}
            </a-button>
          </a-col>
        </a-row>
      ...
      <template v-if="show">
        <a-row
          v-if="carsDataList.length > 0 && typeListActive === 'car'"
          justify="space-around"
          :gutter="[4, 8]">
          <a-col
            v-for="(item, index) of carsDataList.filter((item) => (item.ccmz_36 === carFactoryListActive || !carFactoryListActive) && (item.jb_43 === carGradeListActive || !carGradeListActive))"
            :key="index">
            <a-card>
              <template #title>
                {{ item.cm_4e }}
        ...
        <a-row
          v-if="mapsDataList.length > 0 && typeListActive === 'map'"
          justify="space-around"
          :gutter="[4, 8]">
          <a-col
        ...
        <a-row
          v-if="petsDataList.length > 0 && typeListActive === 'pet'"
          justify="space-around"
          :gutter="[4, 8]">
          <a-col
            v-for="(item, index) of petsDataList"
            :key="index">
