      ...
      <div class="stage-container remove">
        <div class="page_two hide">
          <div id="text" style="display: none">
            <p>
              倒计时<br /><br />还有<span id="time"></span><br /><span id="text1"></span
              ><br />接龙哈！发给你最好的3个朋友<br />超过5个就永远幸福<br />不许在你这里断了！<br />明年到来之前必须发完，不许偷懒<br />想起谁，发给谁，包括我[awa]<br /><br />彩蛋:点击屏幕任意地方即可放烟花<br /><br /><br /><span
                id="copyright"
              ></span>
            </p>
          </div>
          <div id="contents" class="type_words" style="font-size: 1.15rem; line-height: 1.5rem"></div>
        </div>
