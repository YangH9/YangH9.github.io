...
const videoLineList = [
  ...
  { name: '线路1(推荐)', subTitle: 'okjx', url: 'https://okjx.cc/?url=' },
  { name: '线路2', subTitle: 'bozrc', url: 'https://jx.bozrc.com:4433/player/?url=' },
  ...
  { name: '线路6', subTitle: '线路二(诺讯)', url: 'https://www.nxflv.com/?url=' },
