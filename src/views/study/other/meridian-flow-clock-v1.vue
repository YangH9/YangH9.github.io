        ...
        <div class="clock_face">
          ...
          <div class="rotate_box meridian_text">
            <template v-for="(item, index) in meridianList" :key="index">
              <div
                class="rotate_item"
                :style="{
                  transform: `translate(-50%, -50%) rotate(${index * 30 - 90}deg) translateX(${
                    radius * 0.4
                  }px) rotate(${-(index * 30 - 90)}deg)`
                }"
              >
                <div>{{ item.branch }}</div>
              </div>
          ...
          <div class="rotate_box meridian_hour">
            <div
              ...
              class="rotate_item"
              :style="{
                transform: `translate(-50%, -50%) rotate(${index * 15 - 75}deg) translateX(${
                  radius * 0.775
                }px) rotate(${-(index * 15 - 75)}deg)`
              }"
            >
              {{ item }}
            </div>
          ...
          <div class="rotate_box hour">
            <div
              ...
              class="rotate_item"
              :style="{
                transform: `translate(-50%, -50%) rotate(${index * 30 - 60}deg) translateX(${
                  radius * 0.5
                }px) rotate(${-(index * 30 - 60)}deg)`
              }"
            >
              {{ item }}
            </div>
...
const meridianList = [
  ...
  { startTime: 1, endTime: 3, branch: '丑', meridian: '肝', color: '#0a0', tips1: '睡觉', tips2: '养肝排毒，忌熬夜', desc: '“肝藏血。”人的思维和行动要靠肝血的支持，废旧的血液需要淘汰，新鲜血液需要产生，这种代谢通常在肝经最旺的丑时完成。如果丑时不入睡，肝还在输出能量支持人的思维和行动，就无法完成新陈代谢。黄帝内经讲：“卧则血归于肝”。所以丑时未入睡者，面色青灰，情志倦怠而躁，易生肝病。' },
  { startTime: 3, endTime: 5, branch: '寅', meridian: '肺', color: '#0a0', tips1: '深睡', tips2: '养肺排毒，需熟睡', desc: '“肺朝百脉。”肝在丑时把血液推陈出新之后，将新鲜血液提供给肺，通过肺送往全身。所以人在清晨面色红润，精神充沛。寅时，有肺病的人反映尤为强烈，剧咳或哮喘或发烧。' },
  { startTime: 5, endTime: 7, branch: '卯', meridian: '大肠', color: '#0a0', tips1: '排便', tips2: '养肠排毒，饮水排泄', desc: '“肺与大肠相表里。”肺将充足的新鲜血液布满全身，紧接着促进大肠经进入兴奋状态，完成吸收食物中水份与营养、排出渣滓的过程。因此，大便不正常者在此时需要辨证调理。' },
  { startTime: 7, endTime: 9, branch: '辰', meridian: '胃', color: '#0a0', tips1: '早餐', tips2: '养胃时间，宜食早餐', desc: '所以，人在 7点吃早饭最容易消化。如果胃火过盛，嘴唇干，重则唇裂或生疮，可以在7点清胃火。胃寒者7点养胃健脾。' },
  { startTime: 9, endTime: 11, branch: '巳', meridian: '脾', color: '#0a0', tips1: '饮水', tips2: '养脾时间，忌冰寒', desc: '“脾主运化，脾统血。”脾是消化、吸收、排泄的总调度，又是人体血液的统领。“脾开窍于口，其华在唇。”脾的功能好，消化吸收好，血的质量好，所以嘴唇是红润的。否则唇白，或唇暗、唇紫。脾虚者9点健脾；湿盛者9点利湿。' },
  { startTime: 11, endTime: 13, branch: '午', meridian: '心', color: '#0a0', tips1: '午休', tips2: '养心时间，宜午睡', desc: '“心主神明，开窍于舌，其华在面。”心推动血液运行，养神、养气、养筋。人在午时能睡片刻，对于养心大有好处，可使下午乃至晚上精力充沛。心率过缓者11点补心阳；心率过速者滋心阴。' },
  { startTime: 13, endTime: 15, branch: '未', meridian: '小肠', color: '#0a0', tips1: '运动', tips2: '养肠时间，宜运动', desc: '小肠分清浊，把水液归于膀胱，糟粕送人大肠，精华输送进脾。小肠经在未时对人一天的营养进行调整。饭后两肋胀痛者在此时降肝火、疏肝理气；' },
  { startTime: 15, endTime: 17, branch: '申', meridian: '膀胱', color: '#0a0', tips1: '饮水', tips2: '膀胱排毒，饮水排泄', desc: '膀胱贮藏水液和津液，水液排出体外，津液循环在体内。若膀胱有热可致膀胱咳，即咳而遗尿。申时人体温较热，阴虚的人尤为突出，在这个时间滋肾阴可调此证。' },
  { startTime: 17, endTime: 19, branch: '酉', meridian: '肾', color: '#0a0', tips1: '晚餐', tips2: '养肾时间，宜食晚餐', desc: '“肾藏生殖之精和五脏六腑之精。肾为先天之根。”经过申时的人体泻火排毒，肾在酉时进入贮藏精华的时辰。肾阳虚者酉时补肾阳最为有效。' },
  { startTime: 19, endTime: 21, branch: '戌', meridian: '心包', color: '#0a0', tips1: '散步', tips2: '养气时间，宜散步', desc: '“心包为心之外膜，附有脉络，气血通行之道。邪不能容，容之心伤。”心包是心的保护组织，又是气血通道。心包戌时兴旺可清除心脏周围外邪，使心脏处于完好状态。心发冷者戌时补肾阳；心闷热者戌时滋心阴。' },
  { startTime: 21, endTime: 23, branch: '亥', meridian: '三焦', color: '#0a0', tips1: '睡觉', tips2: '养生时间，宜入睡', desc: '三焦是六腑中最大的腑，有主持诸气、疏通水道的作用。亥时三焦通百脉。人如果在亥时睡眠，百脉可休养生息，对身体十分有益。可惜现代人能做到的很少，亥时百脉皆通，所以可以用任何一种进行调理。古籍《灵枢》：“经脉流行不止，与天同度，与地同纪。' }
]
...
const meridianBgDom = ({ item, index, width, inner }) => {
...
.sector {
  ...
  clip-path: path('M 0 43 A 100 100 0 0 1 43 0 L 71 50 A 50 50 0 0 0 50 71  L 0 43 Z');
